...
export const Sidebar = () => {
  ...
  // Removendo getInitials pois o Avatar/Email não são mais usados no rodapé
        ...
        <nav className="space-y-1">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  "flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 w-full", // Removido w-48 e mx-auto
                  isActive
